...
最近发布的完整版本是 [v1.0.20260921](https://github.com/Mutantcat-Working-Group/AndroidBox/releases/tag/v1.0.20260921)，包含五平台安装包及 `SHA256SUMS`。当前源码版本为 `1.0.20260922`，推送匹配标签后同样需要五个平台构建全部通过才会发布。
